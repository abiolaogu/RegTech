# Enterprise Architecture — RegTech
> Version: 1.0 | Last Updated: 2026-02-18 | Status: Draft
> Classification: Internal | Author: AIDD System

## 1. Overview

Enterprise architecture view for RegTech within the BillyRonks Global Limited technology landscape.
...
|------------|------|--------|-------------|
| RegTech Core | Custom | Active | Primary |
